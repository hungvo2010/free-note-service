...
Define the lifecycle and metadata methods of `NetworkRequestData` — the unified abstraction over blocking (Socket) and NIO (SocketChannel) network connections.
